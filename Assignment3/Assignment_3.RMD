...
rm(list=ls())
uni_bank <- read.csv("C:\\Users\\madhu\\OneDrive\\Desktop\\MS\\1stSem\\2.Fundamentals of ML\\Modules\\Mod4\\Assignment\\UniversalBank.csv")
...
melt_uni_bank = melt(train_df, id=c("CreditCard","Personal.Loan"), variable = "Online") # elongated DF to reshape id, var into $value 
